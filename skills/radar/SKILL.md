...
```bash
BASE_URL=https://nuos.github.io/ai-news-radar/data
```
...
- **Pages 404 / 网络失败**：换 raw 地址重试一次：`https://raw.githubusercontent.com/Nuos/ai-news-radar/master/data/latest-24h.json`。还不行就如实告知，不要编造新闻。
